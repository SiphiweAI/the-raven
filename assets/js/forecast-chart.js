document.addEventListener("DOMContentLoaded", function() {
    if (!forecastResults || Object.keys(forecastResults).length === 0) {
        document.getElementById('forecastChart').insertAdjacentHTML('beforebegin', '<p>No forecast data available.</p>');
        return;
    }
